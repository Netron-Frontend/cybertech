...
h.hyperbolicCosine = h.cosh = function () {
	...
	((i = o.precision),
		...
		(o.rounding = 1),
		(r = s.d.length),
		r < 32 ? ((e = Math.ceil(r / 3)), (n = (1 / le(4, e)).toString())) : ((e = 16), (n = '2.3283064365386962890625e-10')),
...
h.hyperbolicTangent = h.tanh = function () {
	...
	return i.isFinite()
		? i.isZero()
			? new t(i)
			: ((e = t.precision), (n = t.rounding), (t.precision = e + 7), (t.rounding = 1), k(i.sinh(), i.cosh(), (t.precision = e), (t.rounding = n)))
		: new t(i.s);
};
h.inverseCosine = h.acos = function () {
	...
	return i !== -1
		...
		: e.isZero()
			? F(n, t + 4, r).times(0.5)
			: ((n.precision = t + 6), (n.rounding = 1), (e = new n(1).minus(e).div(e.plus(1)).sqrt().atan()), (n.precision = t), (n.rounding = r), e.times(2));
};
		...
		? r.e >= 0
			...
			: ((e = s.precision),
				...
				Math.max(t, e) < 2 * -r.e - 1
					? p(new s(r), e, n, !0)
					: ((s.precision = i = t - r.e), (r = k(r.plus(1), new s(1).minus(r), i + e, 1)), (s.precision = e + 4), (s.rounding = 1), (r = r.ln()), (s.precision = e), (s.rounding = n), r.times(0.5)))
		: new s(NaN);
};
		...
		: ((n = r.abs().cmp(1)),
			...
			n !== -1
				? n === 0
					...
					: new s(NaN)
				: ((s.precision = i + 6), (s.rounding = 1), (r = r.div(new s(1).minus(r.times(r)).sqrt().plus(1)).atan()), (s.precision = i), (s.rounding = t), r.times(2)));
};
h.inverseTangent = h.atan = function () {
	...
	for (w = !1, n = Math.ceil(u / m), t = 1, c = f.times(f), o = new l(f), r = f; e !== -1; )
		if (((r = r.times(c)), (s = o.minus(r.div((t += 2)))), (r = r.times(c)), (o = s.plus(r.div((t += 2)))), o.d[n] !== void 0)) for (e = n; o.d[e] === s.d[e] && e--; );
	...
	return (
		...
		!i.d || !e.s || (e.d && !e.d[0])
			...
			: !e.d || (i.d && !i.d[0])
				...
				: ((w = !1), t.modulo == 9 ? ((n = k(i, e.abs(), 0, 3, 1)), (n.s *= e.s)) : (n = k(i, e, 0, t.modulo, 1)), (n = n.times(e)), (w = !0), i.minus(n))
	);
};
...
h.toFixed = function (e, n) {
	var i,
		...
		s = r.constructor;
	return (
		e === void 0 ? (i = L(r)) : (q(e, 0, H), n === void 0 ? (n = s.rounding) : q(n, 0, 8), (t = p(new s(r), e + r.e + 1, n)), (i = L(t, !1, e + t.e + 1))),
	...
	return (
		...
		n > c.maxE + 1 || n < c.minE - 1
			...
			: ((w = !1),
				...
				r.d && ((r = p(r, t + 5, 1)), Q(r.d, t, s) && ((n = t + 10), (r = p(be(e.times(B(u, n + i)), n), n + 5, 1)), +b(r.d).slice(t + 1, t + 15) + 1 == 1e14 && (r = p(r, t + 1, 0)))),
				(r.s = o),
				(w = !0),
				(c.rounding = s),
				p(r, t, s))
...
function Q(e, n, i, t) {
	...
	return (
		...
		t == null
			? n < 3
				? (n == 0 ? (u = (u / 100) | 0) : n == 1 && (u = (u / 10) | 0), (o = (i < 4 && u == 99999) || (i > 3 && u == 49999) || u == 5e4 || u == 0))
				: (o = (((i < 4 && u + 1 == s) || (i > 3 && u + 1 == s / 2)) && ((e[r + 1] / s / 100) | 0) == C(10, n - 2) - 1) || ((u == s / 2 || u == 0) && ((e[r + 1] / s / 100) | 0) == 0))
			: n < 4
				? (n == 0 ? (u = (u / 1e3) | 0) : n == 1 ? (u = (u / 100) | 0) : n == 2 && (u = (u / 10) | 0), (o = ((t || i < 4) && u == 9999) || (!t && i > 3 && u == 4999)))
					...
					((d = 0),
						...
						f < 0
							? ((x = E[0]),
								...
								(d = (x / de) | 0),
								d > 1
									? (d >= c && (d = c - 1), (N = e(S, d, c)), (A = N.length), (P = E.length), (f = n(N, E, A, P)), f == 1 && (d--, i(N, T < A ? y : S, A, c)))
									: (d == 0 && (f = d = 1), (N = S.slice())),
								(A = N.length),
								A < P && N.unshift(0),
								i(E, N, P, c),
	...
	e: if (n != null) {
		...
		if (
			...
			(f =
				i < 4
					? (c || t) && (i == 0 || i == (e.s < 0 ? 3 : 2))
					: c > 5 || (c == 5 && (i == 4 || t || (i == 6 && (s > 0 ? (o > 0 ? l / C(10, r - o) : 0) : a[d - 1]) % 10 & 1) || i == (e.s < 0 ? 8 : 7)))),
			n < 1 || !a[0])
		)
...
function L(e, n, i) {
	...
	return (
		n
			? (i && (t = i - o) > 0 ? (s = s.charAt(0) + '.' + s.slice(1) + U(t)) : o > 1 && (s = s.charAt(0) + '.' + s.slice(1)), (s = s + (e.e < 0 ? 'e' : 'e+') + e.e))
			: r < 0
	...
	for (a = N, c = o = N = k(N.minus(1), N.plus(1), l, 1), d = p(N.times(N), l, 1), r = 3; ; ) {
		if (((o = p(o.times(d), l, 1)), (f = c.plus(k(o, new M(r), l, 1))), b(f.d).slice(0, l) === b(c.d).slice(0, l)))
			if (((c = c.times(2)), s !== 0 && (c = c.plus(ue(M, l + 2, E).times(s + ''))), (c = k(c, new M(g), l, 1)), n == null))
				if (Q(c.d, l - v, _, u)) ((M.precision = l += v), (f = o = N = k(a.minus(1), a.plus(1), l, 1)), (d = p(N.times(N), l, 1)), (r = u = 1));
...
function re(e, n) {
	var i, t, r;
	for (
		(i = n.indexOf('.')) > -1 && (n = n.replace('.', '')), (t = n.search(/e/i)) > 0 ? (i < 0 && (i = t), (i += +n.slice(t + 1)), (n = n.substring(0, t))) : i < 0 && (i = n.length), t = 0;
		n.charCodeAt(t) === 48;
		t++
	);
	...
	if ((v ? (q(i, 1, H), t === void 0 ? (t = g.rounding) : q(t, 0, 8)) : ((i = g.precision), (t = g.rounding)), !e.isFinite())) l = je(e);
		...
		for (
			l = L(e),
				...
				o >= 0 && ((l = l.replace('.', '')), (d = new g(1)), (d.e = l.length - o), (d.d = te(L(d), 10, r)), (d.e = d.d.length)),
				a = te(l, 10, r),
				s = c = a.length;
			a[--c] == 0;
		...
		if (!a[0]) l = v ? '0p+0' : '0';
			...
			if (
				(o < 0 ? s-- : ((e = new g(e)), (e.d = a), (e.e = s), (e = k(e, d, i, t, 0, r)), (a = e.d), (s = e.e), (f = Le)),
				(o = a[i]),
				(u = r / 2),
				(f = f || a[i + 1] !== void 0),
				(f = t < 4 ? (o !== void 0 || f) && (t === 0 || t === (e.s < 0 ? 3 : 2)) : o > u || (o === u && (t === 4 || f || (t === 6 && a[i - 1] & 1) || t === (e.s < 0 ? 8 : 7)))),
				(a.length = i),
				f)
			)
			...
			: !e.d && !n.d
				...
				: !n.d || e.isZero()
					...
					: !e.d || n.isZero()
						...
						: n.s < 0
							? ((this.precision = s), (this.rounding = 1), (i = this.atan(k(e, n, s, 1))), (n = F(this, s, 1)), (this.precision = t), (this.rounding = r), (i = e.s < 0 ? i.minus(n) : i.plus(n)))
...
function Ge(e) {
	...
	function r(s) {
		...
		if (((f.constructor = r), Fe(s))) {
			((f.s = s.s),
				w ? (!s.d || s.e > r.maxE ? ((f.e = NaN), (f.d = null)) : s.e < r.minE ? ((f.e = 0), (f.d = [0])) : ((f.e = s.e), (f.d = s.d.slice()))) : ((f.e = s.e), (f.d = s.d ? s.d.slice() : s.d)));
			return;
		}
...
function Gn(e) {
	...
	if ((e === void 0 ? (e = this.precision) : q(e, 1, H), (t = Math.ceil(e / m)), this.crypto))
		if (crypto.getRandomValues) for (n = crypto.getRandomValues(new Uint32Array(t)); s < t; ) ((r = n[s]), r >= 429e7 ? (n[s] = crypto.getRandomValues(new Uint32Array(1))[0]) : (u[s++] = r % 1e7));
